...
public class DBInit : MonoBehaviour
{
    ...
    private void FixMissing() {
        DBAccess.AddTableIfMissing("saves", "id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL UNIQUE, dif INTEGER, rank INTEGER, last_play TEXT, play_time INTEGER, thumbnail TEXT"); //Table name followed by colume names and datatypes seperated by comma (,)
