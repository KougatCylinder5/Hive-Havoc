...
public class DBInit : MonoBehaviour
{
    ...
    private void FixMissing() {
        ...
        DBAccess.AddTableIfMissing("placeables", "id INTEGER PRIMARY KEY AUTOINCREMENT, tile_item_id INTEGER, save_id INTEGER, x_pos REAL, y_pos REAL, health REAL, natural INTEGER");
